...
function M.set_highlights()
    ...
    hl(0, "SpellRare", { fg = "NONE", bg = "NONE", sp = "#0f4b6e", underline = true })
    ...
    hl(0, "DiagnosticUnderlineHint", { fg = "NONE", bg = "NONE", sp = "#0f4b6e", underline = true })
    ...
    hl(0, "DiagnosticHint", { fg = "#0f4b6e", bg = "#d0d7e0" })
    ...
    hl(0, "DiagnosticSignHint", { fg = "#0f4b6e", bg = "NONE" })
    ...
    hl(0, "@markup.heading.4", { fg = "#0f4b6e", bg = "NONE" })
    ...
    hl(0, "@markup.raw", { fg = "NONE", bg = "#d7d9e2" })
    hl(0, "@markup.raw.block", { fg = "NONE", bg = "#d7d9e2" })
