...
function M.set_highlights()
    ...
    hl(0, "MatchParen", { fg = "NONE", bg = "#c8cbd8" })
    ...
    hl(0, "Operator", { fg = "#343b58", bg = "NONE" })
    ...
    hl(0, "@punctuation.bracket", { fg = "#40434f", bg = "NONE" })
    hl(0, "@punctuation.delimiter", { fg = "#40434f", bg = "NONE" })
    ...
    hl(0, "CmpItemAbbr", { fg = "#343b58", bg = "NONE" })
    ...
    hl(0, "CmpItemKindField", { fg = "#343b58", bg = "NONE" })
    hl(0, "CmpItemKindFile", { fg = "#343b58", bg = "NONE" })
    ...
    hl(0, "CmpItemKindReference", { fg = "#343b58", bg = "NONE" })
    ...
    hl(0, "CmpItemKindValue", { fg = "#343b58", bg = "NONE" })
    hl(0, "CmpItemKindVariable", { fg = "#343b58", bg = "NONE" })
    hl(0, "CmpItemMenu", { fg = "#343b58", bg = "NONE" })
    ...
    hl(0, "TelescopeTitle", { fg = "#343b58", bg = "NONE" })
