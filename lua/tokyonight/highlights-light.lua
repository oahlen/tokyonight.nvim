...
function M.set_highlights()
    ...
    hl(0, "@property", { fg = "#2b3048", bg = "NONE" })
    ...
    hl(0, "@string.special.path", { fg = "#33635c", bg = "NONE" })
    ...
    hl(0, "@variable.member", { fg = "#2b3048", bg = "NONE" })
    hl(0, "@variable.parameter", { link = "Identifier" })
    hl(0, "@constant.bash", { fg = "#2b3048", bg = "NONE" })
    hl(0, "@constant.builtin.rust", { link = "PreProc" })
