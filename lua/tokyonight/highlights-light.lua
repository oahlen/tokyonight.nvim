...
function M.set_highlights()
    ...
    hl(0, "CursorlineNr", { fg = "#965027", bg = "#d7d9e2", bold = true })
    ...
    hl(0, "WinSeparator", { fg = "#c8cbd8", bg = "NONE" })
    ...
    hl(0, "@tag.attribute", { fg = "#2b3048", bg = "NONE" })
    ...
    hl(0, "@constant.bash", { fg = "#2b3048", bg = "NONE" })
    ...
    hl(0, "@property.json", { fg = "#0f4b6e", bg = "NONE" })
    hl(0, "@property.toml", { fg = "#0f4b6e", bg = "NONE" })
    hl(0, "@property.yaml", { fg = "#0f4b6e", bg = "NONE" })
    ...
    hl(0, "@variable.parameter.powershell", { fg = "#2b3048", bg = "NONE" })
    ...
    hl(0, "AgenticTitle", { fg = "#d7d9e2", bg = "#006c86", bold = true })
    hl(0, "AgenticDiffAddWord", { fg = "#d7d9e2", bg = "#385f0d", bold = true })
