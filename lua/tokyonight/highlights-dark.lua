...
function M.set_highlights()
    ...
    hl(0, "DiagnosticOk", { fg = "#9ece6a", bg = "#262d27" })
    hl(0, "DiagnosticInfo", { fg = "#7aa2f7", bg = "#212739" })
    hl(0, "DiagnosticHint", { fg = "#7dcfff", bg = "#222d3a" })
    hl(0, "DiagnosticWarn", { fg = "#e0af68", bg = "#2e2927" })
    hl(0, "DiagnosticError", { fg = "#f7768e", bg = "#31222c" })
    ...
    hl(0, "Identifier", { fg = "#c0caf5", bg = "NONE" })
    hl(0, "Include", { fg = "#7aa2f7", bg = "NONE" })
    ...
    hl(0, "@parameter", { fg = "#e0af68", bg = "NONE" })
    ...
    hl(0, "@variable.parameter", { fg = "#e0af68", bg = "NONE" })
