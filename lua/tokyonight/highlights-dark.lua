...
function M.set_highlights()
    ...
    hl(0, "CursorlineNr", { fg = "#ff9e64", bg = "#212433", bold = true })
    ...
    hl(0, "WinSeparator", { fg = "#292d40", bg = "NONE" })
    ...
    hl(0, "@property.json", { fg = "#73daca", bg = "NONE" })
    hl(0, "@property.toml", { fg = "#73daca", bg = "NONE" })
    hl(0, "@property.yaml", { fg = "#73daca", bg = "NONE" })
    ...
    hl(0, "AgenticTitle", { fg = "#15161e", bg = "#2ac3de", bold = true })
    hl(0, "AgenticDiffAddWord", { fg = "#15161e", bg = "#9ece6a", bold = true })
    hl(0, "AgenticDiffDeleteWord", { fg = "#15161e", bg = "#f7768e", bold = true })
    hl(0, "AgenticSpinnerGenerating", { fg = "#7dcfff", bg = "NONE", bold = true })
    hl(0, "AgenticSpinnerSearching", { fg = "#e0af68", bg = "NONE", bold = true })
    hl(0, "AgenticSpinnerThinking", { fg = "#bb9af7", bg = "NONE", bold = true })
